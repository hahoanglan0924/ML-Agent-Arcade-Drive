...
[assembly: InternalsVisibleTo("VehicleBehaviour.Dots")]
    ...
    public class WheelVehicle : MonoBehaviour {
        ...
        public string throttleInput => m_Inputs.ThrottleInput;
        public string brakeInput => m_Inputs.BrakeInput;
        public string turnInput => m_Inputs.TurnInput;
        public string jumpInput => m_Inputs.JumpInput;
        public string driftInput => m_Inputs.DriftInput;
	    public string boostInput => m_Inputs.BoostInput;
        ...
        [HideInInspector]public Rigidbody rb = default;
